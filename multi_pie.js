...
//var topLevelItem = {label: "Total"};
//
//    var subsubsubData = [
//			 {colorIndex: 0, value: 40, label: "Urban"},
//			 {colorIndex: 1, value: 10, label: "Rural"},
//			 {colorIndex: 2, value: 37, label: "Suburban"}
//			 ];
//    
//    var subsubDataMD = [
//			{colorIndex: 12, value: 3075, childData: subsubsubData, label: "Baltimore"},
//			{colorIndex: 9, value: 6150, childData: subsubsubData, label: "Calvert"},
//			{colorIndex: 10, value: 6832, childData: subsubsubData, label: "Frederick"},
//			{colorIndex: 11, value: 7516, childData: subsubsubData, label: "Cecil"}
//			];
//    
//    var subsubDataWV = [
//			{colorIndex: 12, value: 3075, childData: subsubsubData, label: "Jefferson"},
//			{colorIndex: 9, value: 6150, childData: subsubsubData, label: "Mineral"},
//			{colorIndex: 10, value: 6832, childData: subsubsubData, label: "Morgan"},
//			{colorIndex: 11, value: 7516, childData: subsubsubData, label: "Pendleton"},
//			{colorIndex: 13, value: 6150, childData: subsubsubData, label: "Berkeley"},
//			{colorIndex: 14, value: 6832, childData: subsubsubData, label: "Grant"}
//			];
//    
//    var subDataPro = [
...
var pieDrill = (function pieDrill(all_data, selector, params) {

	console.log(all_data)
	var data = all_data["data"];
	var topLevelItem = all_data['topLevelItem'];
  ...
  visualization.donut.randomize = function() {
      ...
      path.transition().duration(350).attrTween("d", function(a) {
